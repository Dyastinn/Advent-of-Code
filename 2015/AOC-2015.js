class AdventOfCode2015 {
    ...
    NotQuiteLispPartOne(str) {
        ...
        const floorStep = [...str]
            ...
            const CurrentFloor = floorStep.reduce((accumulator, currentValue) => {
    ...
    NotQuiteLispPartTwo(str) {
        ...
        for(let i = 0; i < floorStep.length; ++i){
            currentFloor += (floorStep[i] === '(' ? 1 : -1)
            if(currentFloor == -1) {
                return i + 1
            }
        }
    ...
    IWasToldThereWouldBeNoMathPartOne(strList){
        let totalBox = 0
    ...
    IWasToldThereWouldBeNoMathPartTwo(strList){
        let totalBox = 0
        for(let i = 0; i < strList.length; i++){
  ...
  // Example usage
  const AOC = new AdventOfCode2015();
...
console.log(AOC.IWasToldThereWouldBeNoMathPartTwo(result))
